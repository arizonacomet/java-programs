...
public class java_assigment extends JFrame implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == calculate) {
            ...
            if(none.isSelected())
            {
             disval.setText((price * 0) / 100 + "");
            }
            if(five.isSelected())
            {
             disval.setText((price * 5) / 100 + "");
            }
            if (ten.isSelected())
            {
            ...
            if(none.isSelected())
            {
              netval.setText((price - (price * 0) / 100) + "");
            }
            if(five.isSelected())
            {
            netval.setText((price - (price * 5) / 100) + "");
            }
            if (ten.isSelected())
            {
